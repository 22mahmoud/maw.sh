      ...
      typography: () => ({
        main: {
          css: {
            ...
            '--tw-prose-invert-counters': 'var(--color-neutral-700)',
            '--tw-prose-invert-bullets': 'var(--color-accent)',
            '--tw-prose-invert-hr': 'var(--color-dark)',
            '--tw-prose-invert-quotes': 'var(--color-primary)',
            '--tw-prose-invert-quote-borders': 'var(--color-dark)',
            '--tw-prose-invert-captions': 'var(--color-secondary)',
            '--tw-prose-invert-code': 'var(--color-accent-bright)',
